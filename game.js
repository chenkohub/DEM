...
import { initThemeSelector, applyTheme, getCurrentTheme, isDarkTheme } from './theme-selector.js';
...
function syncSettingsDarkModeBtn() {
  // Now handled by theme-selector.js — kept as no-op for any remaining callers.
}
...
function bindSettingsDrawer() {
  ...
  // Theme selector is now managed by theme-selector.js (header dropdown + settings grid).
  // No dark-mode button wiring needed here.
